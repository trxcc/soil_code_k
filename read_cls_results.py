...
for metric in metrics:
    for env in envs:
        ...
        results_csv = os.path.join(path, f"test_{metric}.csv")
    ...
    result_df.to_csv(f"./{envs[0]}_results/{metric}-Results-{envs[0]}-new-{len(selected_columns)}.csv")
